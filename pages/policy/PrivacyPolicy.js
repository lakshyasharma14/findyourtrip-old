...
function PrivacyPolicy({ providers, csrfToken }) {
  ...
  return (
    <>
      ...
      <main>
        <PrivacyPolicyBody>
        <h1>Privacy Policy for findyourtrip</h1>

        <p>
          At findyourtrip, accessible from https://www.findyourtrip.in/, one of
          ...
          findyourtrip and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in findyourtrip. This policy is not applicable to
        ...
        <p>
          findyourtrip follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, findyourtrip uses &apos;cookies&apos;. These
        ...
        <p>
          ...
          advertising partners of findyourtrip.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on findyourtrip, which are sent
        ...
        <p>
          Note that findyourtrip has no access to or control over these cookies
        ...
        <p>
          findyourtrip&apos;s Privacy Policy does not apply to other advertisers
        ...
        <p>
          findyourtrip does not knowingly collect any Personal Identifiable
...
const PrivacyPolicyBody = styled.section`
