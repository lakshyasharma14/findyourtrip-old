...
const TermsOfService = () => {
  return (
    <div>
      ...
      <p>
        By accessing this Website, accessible from https://www.findyourtrip.in/,
      ...
      <p>
        ...
        on findyourtrip’s Website, even if findyourtrip or an authorize
      ...
      <p>
        The materials appearing on findyourtrip’s Website may include technical,
        typographical, or photographic errors. findyourtrip will not promise
        that any of the materials in this Website are accurate, complete, or
        current. findyourtrip may change the materials contained on its Website
        at any time without notice. findyourtrip does not make any commitment to
      ...
      <p>
        findyourtrip has not reviewed all of the sites linked to its Website and
        is not responsible for the contents of any such linked site. The
        presence of any link does not imply endorsement by findyourtrip of the
      ...
      <p>
        findyourtrip may revise these Terms of Use for its Website at any time
