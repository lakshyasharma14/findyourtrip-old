      ...
      <main>
        <TermsOfServiceBody>
          ...
          <p>
            ...
            https://www.findyourtrip.in/, you are agreeing to be bound by these
          ...
          <p>
            ...
            materials on findyourtrip&apos;s Website for personal,
          ...
          <p>
            This will let findyourtrip to terminate upon violations of any of
          ...
          <p>
            ...
            findyourtrip does not make any representations concerning the
          ...
          <p>
            findyourtrip or its suppliers will not be hold accountable for any
            damages that will arise with the use or inability to use the
            materials on findyourtrip’s Website, even if findyourtrip or an
          ...
          <p>
            The materials appearing on findyourtrip’s Website may include
            technical, typographical, or photographic errors. findyourtrip will
            not promise that any of the materials in this Website are accurate,
            complete, or current. findyourtrip may change the materials
            contained on its Website at any time without notice. findyourtrip
          ...
          <p>
            findyourtrip has not reviewed all of the sites linked to its Website
            and is not responsible for the contents of any such linked site. The
            presence of any link does not imply endorsement by findyourtrip of
          ...
          <p>
            findyourtrip may revise these Terms of Use for its Website at any
          ...
          <p>
            Any claim related to findyourtrip&apos;s Website shall be governed
            by the laws of in without regards to its conflict of law provisions.
          </p>
        </TermsOfServiceBody>
      </main>
      <Footer />
